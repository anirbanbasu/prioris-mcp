...
| `PRIORIS_MCP_EMBEDDING_MODEL` | Name of the embedding model used for vector search (fastEmbed model identifier). Changing this changes the vector table's dimension and causes index_status to report all vectors as stale — see [ADR-00023](requirement-specification/adrs/00023-embedding-model-picker.md). | `BAAI/bge-small-en-v1.5` | — |
