...
`docs/requirement-specification` holds user- and Claude-readable Software Requirement Specifications in Zensical form, tracked in git. Keep it distinct from `docs/superpowers`, which holds Superpowers-plugin-generated intermediate artefacts and is git-ignored — never treat it as committed project documentation.
